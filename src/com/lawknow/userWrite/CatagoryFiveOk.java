...
public class CatagoryFiveOk implements Action {
	...
	public ActionInfo execute(HttpServletRequest req, HttpServletResponse resp) throws IOException {
		...
		req.setAttribute("catagoryOne",userWriteDAO.selectField("기업일반"));
		System.out.println(userWriteDAO.selectField("기업일반"));
		
		actionInfo.setRedirect(false);
		actionInfo.setPath("/category6.jsp");
