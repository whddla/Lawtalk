...
public class CatagoryFourOk implements Action {
	...
	public ActionInfo execute(HttpServletRequest req, HttpServletResponse resp) throws IOException {
		...
		req.setAttribute("catagoryOne",userWriteDAO.selectField("재산범죄"));
		System.out.println(userWriteDAO.selectField("재산범죄"));
		
		actionInfo.setRedirect(false);
		actionInfo.setPath("/category5.jsp");
