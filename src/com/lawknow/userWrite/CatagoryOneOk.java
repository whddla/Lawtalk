...
public class CatagoryOneOk implements Action {
	...
	public ActionInfo execute(HttpServletRequest req, HttpServletResponse resp) throws IOException {
		...
		req.setAttribute("catagoryOne",userWriteDAO.selectField("상속"));
		System.out.println(userWriteDAO.selectField("상속"));
		
		actionInfo.setRedirect(false);
		actionInfo.setPath("/category2.jsp");
