...
public class CatagorySixOk implements Action {
	...
	public ActionInfo execute(HttpServletRequest req, HttpServletResponse resp) throws IOException {
		...
		req.setAttribute("catagoryOne",userWriteDAO.selectField("형사기타"));
		System.out.println(userWriteDAO.selectField("형사기타"));
		
		actionInfo.setRedirect(false);
		actionInfo.setPath("/category7.jsp");
