...
<section class="about-lawknow">
    <header class="menu" >
      <nav class="clearfix">
        <ul class="clearfix">
          <li><a href="" style="color:#ff6d37;">LAWKNOW</a></li> <!--""<-여기 부분에 URL 작성하면 됨-->
          <li><a href="http://www._____.com/About">지식인</a></li>
          <li><a href="http://www._____.com/Project">1:1바로상담</a></li>
          <li><a href="http://www._____.com/Travel">분야 별 글 목록</a></li>
      </ul>
    </nav>
    </header>
    <div class="section-layout-text">
      ...
      <a class="button-border button-layout">상담 글 등록</a><!-- 글작성하는곳 링크  -->
      <br>
    		...
    		<div class="section-last-layout">
    			<div class="last-menu-layout">
    				<div class="last-menu">
    					...
    					<a class="last-button-border">글 작성하러 가기</a><!-- 글작성하는곳 링크  -->
    				</div>
    				<div class="last-menu1">
    					<h3>변호사로 활동을 원하신다면<br>마음껏 답변해보세요!</h3>
    					<a class="last-button-border">답변하러 가기</a><!-- 글작성하는곳 링크  -->
    				</div>
       ...
       <footer class="lt-footer">
                ...
                <div class ="secondbox">
                    <ul class="footer__menu">
                        <li class="lists">
                            <a href="" class="footera" style="padding-left: 36px;">
                    ...
                    <div class = "informationfooter">
                        <div class="mypagebox">
                            ...
                            <div class="mypageboxex">
                                <a href=""  style="color:black;">내 상담 내역</a>
                            </div>
                            <div class="mypageboxex">
                               <a href=""  style="color:black;"> 회원 정보 수정</a>
                            </div>
                        </div>
                        <div class="mypagebox mypageboxtwo">
                            ...
                            <div class="mypageboxex">
                        		<a href=""  style="color:black;">자주 묻는 질문</a>
                            </div>
                            <div class="mypageboxex">
                       			 <a href=""  style="color:black;">회사소개</a>
                            </div>
                            <div class="mypageboxex">
				 				<a href=""  style="color:black;">이용약관</a> <!--이용약관 링크 -->
                            </div>
                            <div class="mypageboxex">
				 				<a href=""  style="color:black;">법적책임</a> 
                            </div>
                        </div>
                    </div>
                </div>    
