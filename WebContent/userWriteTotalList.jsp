...
<html>
	...
	<body class="is-preload">
		...
		<c:set var="userWrite" value="${UserwriteList}"/>
												...
												<c:choose>
													<c:when test="${boardList != null and fn:length(boardList) > 0}">
														<c:forEach var="userWrite" items="${UserwriteList}">
															<tr>
																<td>${userWrite.getUserWriteNum()}</td>
																<td>
																	<a href="${pageContext.request.contextPath}/board/BoardDetailOk.bo?boardNumber=${userWrite.getUserWriteNum()}&page=${page}">${userWrite.getTitle()}</a>
																</td>
																<td>${userWrite.getMemberId()}</td>
