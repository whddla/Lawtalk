	...
	<div class="container">
		<div class="all-layout">
			<div class ="title-layout">
				<h1>
					<a class = "title-font" href="UserLoginOk.ul">LawKnow</a>
			...
			<div class = "allform-layout">
				...
				<div class="footer">
					<div class= "row" style ="display:flex; justify-content: space-around;">
						...
						<a href="UserLoginOk.ul" style="color: #545352; font-size: 12px; text-decoration: none; ">로노 메인</a>
					</div>
					<div class ="row">
						<a href="UserLoginOk.ul" style="color: #a9a7a6; font-size: 10px; text-decoration: none; ">(C) Law..Company Co.Ltd.</a>
					</div>
				</div>
			</div>	
		</div>
