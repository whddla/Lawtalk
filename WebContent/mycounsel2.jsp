        ...
        <div class="mycounsel">
            <p class="qna-page-title">
                ...
                <c:if test="${userWriteCount>0}">
                	<c:out value="${userWriteCount}">개의 답글을 작성하셨습니다</c:out>
                </c:if>
            </p>
        </div>
    </div>
        <div class="big-box">
            ...
            <section class="qna-list-contents">
                <div class="historybox">
                    ...
                    <!--jstl-->
                    <!-- userwrite의 제목과 내용  -->
                    <c:if test ="${empty lawyerUpdateTitle and empty lawyerUpdateTitle}">
                        작성한 답글이 없습니다.
                     </c:if>
                     <c:if test ="${not empty lawyerUpdateTitle}">
                    <div style="display:flex;" class="jstlBigBox">
                     <div class = "seedivOne" style="width:500px"><c:out value=""/>질문 분야 : ${field}</div>
                     <div class = "seedivTwo"><c:out value=""/>제목 :${lawyerUpdateTitle}</div>
                    </div>
                    <div class = "seedivThree"><c:out value=""/>${lawyercontent}</div>
