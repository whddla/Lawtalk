...
<head>
    ...
    <body style="overflow-x: hidden;">
        <div class="all-layout">
            ...
            <hr class="line1">
            <div class="box"></div>
            <div class="box_word">LawTalk badge</div>
    ...
    <div class="lab1">
        <label for="check11">
            <img src="assets/img/예약준수.jpg" class="img1">
        </label>
    </div>
    <div class="lab2">
        <label for="check22">
            <img src="assets/img/해결사.jpg" class="img2">
        </label>
    </div>
    <div class="lab3">
        <label for="check33">
            <img src="assets/img/답변가.jpg" class="img3">
        </label>
    </div>
    <div class="lab4">
        <label for="check44">
            <img src="assets/img/크리에이터.jpg" class="img4">
        </label>
    </div>
    <div class="lab5">
        <label for="check55">
            <img src="assets/img/쉽고친절한.jpg" class="img5">
        </label>
    </div>
