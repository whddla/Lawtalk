...
<body>
    <div class="all-layout">
        ...
        <div class="graybox">dddddddddd</div>
        ...
        <div class="boxs3">
            ...
            <div id="lawer_list">
                <div class="profile_word1">예약준수</div>
                <div class="profile_word1_img">
                    <img src="assets/img/약속.png">
                </div>
            ...
            <div id="lawer_list2">
                <div class="profile_word1_2">답답함해소 변호사</div>
                <div class="profile_word1_img_2">
                    <img src="assets/img/약속.png">
                </div>
            ...
            <div id="lawer_list3">
                <div class="profile_word1_3">해결사</div>
                <div class="profile_word1_img_3">
                    <img src="assets/img/약속.png">
                </div>
            ...
            <div id="lawer_list4">
                <div class="profile_word1_4">명쾌한 변호사</div>
                <div class="profile_word1_img_4">
                    <img src="assets/img/약속.png">
                </div>
            ...
            <div id="lawer_list5">
                <div class="profile_word1_5">꼼꼼한 변호사</div>
                <div class="profile_word1_img_5">
                    <img src="assets/img/약속.png">
                </div>
