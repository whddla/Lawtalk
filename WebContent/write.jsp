...
<body style="overflow-x: hidden;">
  ...
  <label class="btn btn-outline-danger " for="btnradio1"  style ="border-color: #f50; color:#f50;     font-weight: bold; color:black;">이혼</label>

  <input value ="상속" type="radio" class="btn-check " name="field" id="btnradio2" autocomplete="off">
  <label class="btn btn-outline-danger" for="btnradio2" style ="border-color: #f50; color:#f50;    font-weight: bold;color:black;">상속</label>

  <input value ="성범죄" type="radio" class="btn-check" name="field" id="btnradio3" autocomplete="off">
  <label class="btn btn-outline-danger" for="btnradio3" style ="border-color: #f50; color:#f50;    font-weight: bold;color:black;">성범죄</label>
  
  <input value ="건설/부동산"  type="radio" class="btn-check" name="field" id="btnradio4" autocomplete="off" >
  <label class="btn btn-outline-danger" for="btnradio4"style ="border-color: #f50; color:#f50;    font-weight: bold;color:black;">건설/부동산</label>

  <input value ="재산범죄" type="radio" class="btn-check" name="field" id="btnradio5" autocomplete="off">
  <label class="btn btn-outline-danger" for="btnradio5" style ="border-color: #f50; color:#f50;    font-weight: bold;color:black;">재산범죄</label>

  <input value ="기업일반" type="radio" class="btn-check" name="field" id="btnradio6" autocomplete="off">
  <label class="btn btn-outline-danger" for="btnradio6" style ="border-color: #f50; color:#f50;    font-weight: bold;color:black;">기업일반</label>
  
  <input value ="형사기타" type="radio" class="btn-check" name="field" id="btnradio7" autocomplete="off">
  <label class="btn btn-outline-danger" for="btnradio7" style ="border-color: #f50; color:#f50;    font-weight: bold;color:black;">형사기타</label>
</div> 
</div>
        <div id="text">
          ...
          <div class="text_6">*</div>    
            ...
            <textarea id="input2" rows="30"name ="content" style="resize: none;height: 137px; wrap:on;" type="text" placeholder="&nbsp;&nbsp;&nbsp;내용을 작성해주세요"></textarea>
...
<script>
    ...
    if (this.value == '이혼') {
        alert("이혼 분야의 질문글을 작성해주세요");
    }
    else if (this.value == '상속') {
        alert("상속 분야의 질문글을 작성해주세요");
    }
    else if (this.value == '성범죄') {
        alert("성범죄 분야의 질문글을 작성해주세요");
    }
    else if (this.value == '건설/부동산') {
        alert("건설/부동산 분야의 질문글을 작성해주세요");
    }
    else if (this.value == '재산범죄') {
        alert("재산범죄 분야의 질문글을 작성해주세요");
    }
    else if (this.value == '기업일반') {
        alert("기업일반 분야의 질문글을 작성해주세요");
    }
    else if (this.value == '형사기타') {
        alert("형사기타 분야의 질문글을 작성해주세요");
    }
});
