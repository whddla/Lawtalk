...
<head>
    ...
    <link rel="stylesheet" href="assets/css/css/myhistory.css">
                ...
                <div class="bottombox">
                    ...
                    <div class="phone-advice">
                       <span class="fkfk">ROWKNOW 지식 IN<br>
                        ...
                        <a class="linkline">ROWKNOW 지식 IN ></a>
                    </div>
                    <div class="slash">
                    ...
                    <div class="phone-advice">
                        ...
                        <a class="linkline">ROWKNOW 1:1 바로상담 ></a>
                    </div>
                    </div>  
                </div>
            </section>
...
<!-- <div class="onebox">
    <div class="oneinner">
        <div>
            <img  class = "pencil" src="assets/css/img/글쓰기.jpg">
            <span class="pencilwrtie">
                RAWKNOW 지식인 상담 지금바로 시작하세요!
            </span>
        </div>
    </div>
    <div class="oneinnertwo">
        <span>
             ROWKNOW 지식IN 지금 상담을 시작하세요. 다양한 전문가들이 당신을 기다리고 있습니다.
        </span>
    </div>
</div>
<div class="twobox">
